    ...
    If isBody = False Then '刷新表头数据
        ...
        Select Case cVouchType
            ...
            Case Else
                ...
                If Head_filter.GetSQLWhere <> "" Then
                        GetSQLWhere = GetSQLWhere & " and " & Head_filter.GetSQLWhere
                    End If
...
'        End If
      Case "tlbmakevouch"  '确定
            ...
            cls_UI.Full_Voucher Dest_Voucher, Source_Cardnum, Dest_Cardnum, RefdomH, RefdomB, DomHead_Dest, DomBody_Dest, strErr, Suc
            If Suc Then
                Me.Hide
            Else
...
For Each Attributes In DomHead_Dest.selectSingleNode("//z:row").Attributes
    ...
    If Left(LCase(Attributes.nodeName), 2) = "t_" Then
        ...
        End If
    Else
        If GetHeadItemValue(RefdomH, Attributes.nodeName) <> "" Then
            Attributes.Value = GetHeadItemValue(RefdomH, Attributes.nodeName)
        End If
    End If
Next
