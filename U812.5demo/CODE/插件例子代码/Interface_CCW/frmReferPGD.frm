...
Begin VB.Form frmReferPGD 
   Caption         =   "生单列表"
   ClientHeight    =   6555
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10965
   Icon            =   "frmReferPGD.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   6555
   ScaleWidth      =   10965
        ...
        Select Case cVouchType
            ...
            Case Else
                ...
                For i = 1 To Head_filter.FilterList.Count
                    ...
                    If LCase(Head_filter.FilterList.Item(i).FieldName) = LCase("dep") Then
                        deps = Head_filter.FilterList.Item(i).varValue
                        Head_filter.FilterList.Item(i).varValue = ""
                        Head_filter.FilterList.Item(i).varValue2 = ""
                    ElseIf LCase(Head_filter.FilterList.Item(i).FieldName) = LCase("banci") Then
                        banci = Head_filter.FilterList.Item(i).varValue
                        Head_filter.FilterList.Item(i).varValue = ""
                        Head_filter.FilterList.Item(i).varValue2 = ""
                    End If
                Next
...
Function Init(m_login As U8Login.clsLogin, DBcon As ADODB.Connection, Frm As Object, Dest_Domh As DOMDocument, Dest_Domb As DOMDocument, Source_Cardnumber As String, Dest_Cardnumber As String) As Boolean
...
Dim i As Long
Dim t_ccuscode As String
Dim k As Long
    t_ccuscode = ""
    For i = 1 To ctlReferMakeVouch1.BodyList.rows - 1
        '处理多选的问题 ccw t_ccuscode
        If ctlReferMakeVouch1.BodyTextMatrix(i, ctlReferMakeVouch1.GetBodyColIndex("selcol")) = "Y" And t_ccuscode = "" Then
        ...
        If (i <> k) And _
                ...
                (t_ccuscode <> ctlReferMakeVouch1.BodyTextMatrix(i, ctlReferMakeVouch1.GetBodyColIndex("t_ccuscode"))) Then
