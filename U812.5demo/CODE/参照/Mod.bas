...
Public sourcetypetmp As String
...
'功能权限
Public Const AuthBrowse = "FSFY02010101" '浏览
Public Const AuthBrowselist = "FSFY02010203" '浏览
...
'    End If
    ...
    If LCase(getAccinformation("ST", "bDepartmentCheck", conn)) = "true" Then
        ...
        sAuth_ALL = sAuth_ALL & IIf(sAuth_depR = "", "", " and ( isnull(coldepartcode,'')='' or coldepartcode in (" & sAuth_depR & ")) ")
        sMakeAuth_ALL = sMakeAuth_ALL & IIf(sAuth_depR = "", "", " and ( isnull(coldepartcode,'')='' or coldepartcode in (" & sAuth_depR & ")) ")
        sAuth_AllList = sAuth_AllList & IIf(sAuth_depR = "", "", " and ( isnull(coldepartcode,'')='' or coldepartcode in (" & sAuth_depR & ")) ")
