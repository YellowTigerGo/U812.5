...
Public Const sKey_Collection = "Collection"               '现付
Public Const sKey_CancelCollection = "CancelCollection"   '弃付
...
Public strCollection As String  ' "现付"
Public strCancelCollection As String  ' "弃付"
...
Public Sub InitMulText()
    ...
    strCollection = GetString("U8.DZ.JA.btn180")    '现付"
    strCancelCollection = GetString("U8.DZ.JA.btn190")    '弃付"
    ...
    With Toolbar
        ...
        Case SHOW_ALL
           ...
           .Buttons("Prorefer1").Enabled = True
            ...
            sql = "SELECT iStatus,iswfcontrolled,iverifystate,1 as Closed FROM " & MainTable & " WHERE ID=" & lngVoucherID
